...
- **LM-032 still LIVE (needs owner reword):** "Level the playing field with the **Big 4**…" appears on BOTH index.html hero subtext AND about.html hero subtext. Reword to "incumbent consultancies"/"global advisory firms" (no firm name) per LM-032.
