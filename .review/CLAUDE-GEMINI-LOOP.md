...
- **LM-141 finding (per-product accent INCONSISTENT):** CSRD uses lime `#C2FF57` (button + eyebrow dot) ✓ but **CrowESG uses TEAL** for "Join the waitlist" — both sustainability family, should be lime. GEMINI: make CrowESG lime to match CSRD. (CrowMark=purple ✓, Cyber/Cash/Core=teal ✓.)
