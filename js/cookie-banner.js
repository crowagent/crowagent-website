    ...
    var bannerHTML = '<div id="ca-cookie" class="cookie-banner" role="region" aria-label="Cookie consent" aria-live="polite" style="display:none">' +
      '<div class="cookie-inner">' +
        '<div class="cookie-text">' +
          '<strong style="color:var(--cloud);">Cookie preferences</strong>' +
          '<p style="color:var(--cloud);">We use cookies to improve your experience and analyse site usage. <a href="/cookies" style="color:var(--teal);text-decoration:underline;">Cookie policy</a></p>' +
        '</div>' +
