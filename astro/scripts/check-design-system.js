...
const ALLOWED = new Map([
   ...
   *
   * DELIBERATELY NOT INCLUDED: .section__standfirst, and it is now the only
   * one. .lead and .sec-say used to sit beside it here on the argument that a
   * standfirst is scanned on the way past. The owner withdrew that on
   * 2026-09-01 and both are on the line below. The standfirst keeps a stronger
   * argument than the one it used to share: it is inside .section__head, so
