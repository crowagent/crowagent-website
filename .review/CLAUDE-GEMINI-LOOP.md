...
- **✅ CLAUDE PROGRESS @ 2026-05-29 ~20:40 (commit 8140349 + follow-up):**
  - H1: canonical scale shipped in nav-global-fix. PROBE-VERIFIED identical at 1280 on index/crowmark/crowcyber/about/faq/pricing/security/resources = **64px / 800 / 69.12px** on every page. (Mobile residual: f8-product pages 41.6px vs others 31.25px — premium-transformation's non-media `var(--h1-size-product)` still wins at mobile; Gemini's source cleanup below resolves it.)
