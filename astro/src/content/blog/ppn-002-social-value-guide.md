...
description: "PPN 002: complete guide to social value scoring on UK government bids. Missions, TOMs, National TOMs proxy values, audit trail, common pitfalls."
...
Procurement Policy Note 002 (PPN 002) is the UK government rule that requires public sector buyers to score social value as at least 10% of the award decision on central government contracts. In plain terms: when you bid for public work, some of your marks now depend on the wider economic, social, and environmental benefit you will deliver alongside the contract itself, not just your price and technical quality. PPN 002 took effect on 24 February 2025 under the Procurement Act 2023, continuing and updating the framework first set by Procurement Policy Note 06/20 in 2021. It applies to all contracts subject to the Public Contracts Regulations and, increasingly, to work let by local authorities, NHS trusts, housing associations, and other public bodies that have adopted the same standard voluntarily.
...
Across these five missions, evaluators repeatedly reward a set of specific, named commitments because they are concrete and straightforward to verify. The strongest responses tend to include several of the following:

- **Real Living Wage.** A commitment to pay the Real Living Wage Foundation rate, not only the statutory National Living Wage, to everyone working on the contract.
- **Apprenticeships and skills.** A stated number of apprenticeships created and training hours delivered, ideally targeted at disadvantaged groups in the delivery area.
- **Carbon Reduction Plan.** A published Carbon Reduction Plan setting out your Scope 1, 2, and 3 baseline and net zero pathway. A compliant plan is a prerequisite for bidding on many central government contracts above the Find a Tender threshold under PPN 06/21.
- **Disability Confident.** Current Disability Confident status under the Department for Work and Pensions scheme, which runs at three levels: Committed, Employer, and Leader.
- **Armed Forces Covenant.** A signed Armed Forces Covenant, particularly valued in defence and security procurements.
- **Local and SME/VCSE supply chain.** A defined percentage of subcontract value directed to local businesses, SMEs, and VCSEs (voluntary, community, and social enterprises).
...
What makes the TOMs framework powerful for scoring purposes is the use of **proxy values** from the National TOMs. Each measure is assigned a monetary proxy value based on peer-reviewed research and econometric modelling. These proxy values represent the estimated economic and social benefit generated by each unit of a given measure.

For example, the National TOMs 2023-24 edition assigns a proxy value of approximately **£8,460** to each Level 3 or above apprenticeship, and **£27,000** to each sustained job for a long-term unemployed resident. These are the same constants our [calculator methodology](/tools/ppn-002-calculator/methodology) publishes and the product applies. Similarly, each hour of volunteering is assigned a proxy value, each tonne of CO2 avoided has a proxy value, and so on across the full range of measures.
...
- **Responding to the wrong missions.** Each procurement specifies which missions apply. Offering measures against missions the buyer has not selected wastes word count and signals a lack of attention to the brief.
- **Overclaiming beyond what you can evidence.** Post-award reporting is now standard. Committing to measures you cannot evidence risks penalty clauses and damages your credibility on future bids.
- **Outdated or misapplied proxy values.** Using an older edition of the National TOMs, applying the wrong proxy to a measure, or double-counting one activity across several measures all produce figures that do not stand up to scrutiny.
...
When you enter your contract profile, including sector, contract value, geography and duration, CrowMark maps your contract to the relevant PPN 002 missions using a rules-based engine. The mapping follows the Cabinet Office's own guidance on mission relevance by sector and contract type.

### TOMs library with National TOMs proxy values

CrowMark includes the full National TOMs measures library with National TOMs 2023-24 proxy values built in. You can browse measures by mission, filter by relevance to your sector, and see the proxy value for each measure before selecting it. The platform calculates your total social value score in real time as you add or adjust measures, so you can optimise your response before submission.
...
> **Ready to score your next bid?** CrowMark handles PPN 002 mission mapping, TOMs scoring with National TOMs proxy values, AI narrative drafting, and evidence tracking, all in one platform. [Request access](/contact?enquiry=limited-access#contact-form)
...
- Cabinet Office, PPN 06/20: Taking account of social value in the award of central government contracts: [gov.uk](https://www.gov.uk/government/publications/procurement-policy-note-0620-taking-account-of-social-value-in-the-award-of-central-government-contracts)
- Cabinet Office, Social Value Model: [gov.uk/government/publications/social-value-model](https://www.gov.uk/government/publications/social-value-model)

Last reviewed: 26 July 2026. Proxy values cited reference the National TOMs 2023-24 edition; always confirm current figures against the latest published edition before submission.
