...
- Name: responsive.spec.js >> Responsive viewport matrix >> 320×800 (mobile-xs (iPhone SE portrait)) — /pricing.html
- Location: tests\responsive.spec.js:49:7

# Error details

```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://localhost:8081/pricing.html
Call log:
  - navigating to "http://localhost:8081/pricing.html", waiting until "domcontentloaded"
