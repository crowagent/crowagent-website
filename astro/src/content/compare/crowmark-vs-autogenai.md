...
<source type="image/webp" srcset="/Assets/shots/figma-v2/sup-2-tender-questions-light.webp?v=20260805a">
<img src="/Assets/shots/figma-v2/sup-2-tender-questions-light.png?v=20260805a" width="2880" height="1800" loading="lazy" decoding="async" alt="The CrowMark tender questions screen, headed by the contract, its &pound;4,250,000 estimated value, its social value requirement, a deadline of 7 Jun 2026 and the buying authority, with a stage strip running overview, documents, response, review, delivery and outcome. A banner states that answers are AI-assisted and grounded only in your own answer library, the published requirement and your confirmed commitments, that every figure comes from your engine-computed commitments and is never invented, and that a named human reviews, edits and approves every answer before you submit it. Four scored questions are listed below, each with a category, a word limit, a weighting and an action: a quality question on mobilising the contract within eight weeks, a social value question on measurable commitments and how each will be evidenced, a compliance question on safeguarding and statutory duties, and a further quality question on continuous improvement. The first three offer Draft answer and the last shows Review draft." />
</picture>
